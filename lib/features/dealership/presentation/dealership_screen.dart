...
class DealershipScreen extends ConsumerWidget {
  ...
  static const List<VehicleDealItem> vehicles = [
    VehicleDealItem(
      ...
      subtitle: 'Başlangıç aracı. Hızlı şehir içi depolar için ideal.',
      gridWidth: 10,
      gridHeight: 6,
      maxWeightKg: 350,
      price: 0,
    ...
    VehicleDealItem(
      ...
      subtitle: 'Daha büyük kasa ve %100 daha fazla taşıma kapasitesi.',
      gridWidth: 12,
      gridHeight: 16,
      maxWeightKg: 750,
      price: 2500,
    ...
    VehicleDealItem(
      ...
      subtitle: 'Maksimum bagaj ızgarası ve 3.5 tonluk devasa taşıma gücü.',
      gridWidth: 18,
      gridHeight: 28,
      maxWeightKg: 3500,
      price: 25000,
