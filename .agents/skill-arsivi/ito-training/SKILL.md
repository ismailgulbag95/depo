---
name: ito-training
description: "Inspect the availability of ML training on a completed Itô compute booking and, when the canonical backend becomes available, hand off an explicitly confirmed training manifest. Use after ito-compu..."
metadata:
  origin: ECC
  status: scaffold
---
